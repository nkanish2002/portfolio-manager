export function SettingsPage() {
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-gray-900/80 backdrop-blur border border-slate-dark rounded-lg p-4 sm:p-6">
        ...
        <div className="space-y-3 sm:space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-3 sm:p-0">
            ...
            <span className="self-start sm:self-center px-3 py-1 bg-emerald-900/30 text-emerald-400 text-xs rounded-full">Active</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-3 sm:p-0">
            <div>
            ...
            <span className="self-start sm:self-center px-3 py-1 bg-slate-800 text-slate-400 text-xs rounded-full">Pending</span>
          </div>
        </div>
      </div>
